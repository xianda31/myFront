...
import { Article, Order } from './shop.model';
...
export class ShopService implements OnInit{
  ...
  constructor() {
    this.articleList = [
      ...
      {
        genericName:'Tournoi',
        options: [{name: 'Carte', price:0},{name: 'Espèce 3€', price:3},{name: 'Espèce 4€', price:3},{name: 'Gratuité', price:0}]
      },
      {
        genericName:'Carte',
      ...
      },
      {
        ...
        options: [{name: 'Adhésion individuelle', price:32}, {name: 'Adhésion couple', price:27}]
      },
      {
        genericName:'Licence',
